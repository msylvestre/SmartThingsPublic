...
def installed() {
	...
	atomicState.bucketKey = "K59KKGLJFF3V" //change if needed
	atomicState.bucketName = "testBucket" //change if wanted
	atomicState.accessKey = "8NGemwkcvJezQALtK73nZewwoSSU4GHs" //MUST CHANGE
